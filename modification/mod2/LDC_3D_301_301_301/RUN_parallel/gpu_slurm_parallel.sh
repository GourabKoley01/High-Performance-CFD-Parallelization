...
#mpirun -np $SLURM_NTASKS ./VYOM3D_mod2.exe > log.vyomtest_mod2
#echo "Run complete" 
...
nsys profile \
    --trace=cuda,nvtx,mpi \
    -o gpu_profile_VYOM3D_mod2 \
     mpirun -np $SLURM_NTASKS ./VYOM3D_mod2.exe

nsys stats --report cuda_gpu_kern_sum,mpi_event_sum,nvtx_pushpop_sum gpu_profile_VYOM3D_mod2.nsys-rep
