...
#mpirun -np $SLURM_NTASKS ./VYOM3D_mod6.exe > log.vyomtest_mod6
#echo "Run complete" 
...
nsys profile \
   --trace=cuda,nvtx,mpi \
   -o gpu_profile_VYOM3D_mod6 \
   mpirun -np $SLURM_NTASKS ./VYOM3D_mod6.exe

nsys stats --report cuda_gpu_kern_sum,mpi_event_sum,nvtx_pushpop_sum gpu_profile_VYOM3D_mod6.nsys-rep
